...
| `* * *`  | TA                                          | view the attendance/participation records of all the students in TAHub  | identify students who are lagging behind in tutorials             |
| `* * *`  | TA                                          | mark students who are not present with valid reasons as excused         | track student attendance more easily                              |
| `* *`    | TA                                          | view trends                                                             | easily identify students who need extra support                   |
...
| `* *`    | TA                                          | search for students by partial name, email                              | quickly find the right person                                     |
