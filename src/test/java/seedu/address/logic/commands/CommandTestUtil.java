...
public class CommandTestUtil {
    ...
    public static final String COMPANY_DESC_POPULAR = " " + PREFIX_COMPANY + VALID_COMPANY_POPULAR;
    public static final String COMPANY_DESC_WATSONS = " " + PREFIX_COMPANY + VALID_COMPANY_WATSONS;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withCompany(VALID_COMPANY_POPULAR).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withCompany(VALID_COMPANY_WATSONS).withEmail(VALID_EMAIL_BOB)
